...
CREATE VIEW [GLUE].[AlarmView2]
AS

SELECT 
c.location
,glue.Controller.Name as Teamstername
...
where H.c_status= ' '
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'GLUE', @level1type = N'VIEW', @level1name = N'AlarmView2';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'    Right = 516
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'GLUE', @level1type = N'VIEW', @level1name = N'AlarmView2';
