...
CREATE PROCEDURE [GLUE].[sp_GADATAGLUEcockpit3]
--timeparameters
...
SELECT DISTINCT  vgm.Controller as RobotName,vgm.time as timestamp,vgm.vultijd_s,vgm.Year,vgm.Week,vgm.Day,vgm.RefAVG,vgm.RefSTDEC,vgm.UCLnumber,vgm.UCL3,vgm.UCL4,vgm.UCL5,vgm.UCLx,vgm.RefDp,vgm.RefSS
 FROM GADATA.glue.vultijdspcviewer3 as vgm
where 
