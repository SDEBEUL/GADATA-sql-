...
CREATE PROCEDURE [GLUE].[sp_GADATAGLUEcockpitoud]
--timeparameters
...
SELECT DISTINCT  vgm.Controller as RobotName,vgm.time as timestamp,vgm.gemiddelde_vultijd_s,vgm.Year,vgm.Week,vgm.Day,vgm.RefAVG,vgm.RefSTDEC,vgm.LCL,vgm.UCL,vgm.RefDp,vgm.RefSS
 FROM GADATA.glue.vultijdspcvieweroud as vgm
where 
