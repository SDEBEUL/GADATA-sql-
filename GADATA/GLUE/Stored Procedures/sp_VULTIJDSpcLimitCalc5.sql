...
SELECT 
*
FROM GADATA.GLUE.VULTIJDreferentie3 as vgm
where  
...
,ROUND(AVG(vgm.gemiddelde_vultijd_s)+(@UCLnumber*Stdev(vgm.gemiddelde_vultijd_s)),2) as 'UCLx'
...
DELETE GLUE.VULTIJDreferentie3 FROM GLUE.VULTIJDreferentie3 as ref 
Where ref.Controller LIKE @Teamstername-- AND ref.tool_id LIKE @Toolmask
---------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------
--Print 'calculate new limits'
---------------------------------------------------------------------------------------
INSERT INTO GLUE.VULTIJDreferentie3
select 
 vgm.Controller as 'Controller_id'
,Min(vgm.time) as 'SampleStart'
,Max(vgm.time) as 'SampleEnd'
