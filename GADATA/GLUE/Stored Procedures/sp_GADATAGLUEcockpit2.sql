...
CREATE PROCEDURE [GLUE].[sp_GADATAGLUEcockpit2]
--timeparameters
...
SELECT DISTINCT  vgm.Controller as RobotName,vgm.time as timestamp,vgm.vultijd_s,vgm.Year,vgm.Week,vgm.Day,vgm.RefAVG,vgm.RefSTDEC,vgm.UCL1,vgm.UCL2,vgm.UCL3,vgm.UCL4,vgm.UCL5,vgm.RefDp,vgm.RefSS
 FROM GADATA.glue.vultijdspcviewer2 as vgm
where 
