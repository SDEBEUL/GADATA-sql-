...
, DATEDIFF(MINUTE,(H.StartOfBreakdown +  H.Rt),H.EndOfBreakdown) as ReolvT
, T.Vyear AS 'Year'
, T.Vweek AS 'Week'
, T.Vday AS 'day'
, T.ploeg AS 'Shift'
...
(H.Trig_state  & 64 = 64)
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'C4G', @level1type = N'VIEW', @level1name = N'ResolveTime';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'70
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'C4G', @level1type = N'VIEW', @level1name = N'ResolveTime';
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         Column = 1440
         Alias = 900
         Table = 11', @level0type = N'SCHEMA', @level0name = N'C4G', @level1type = N'VIEW', @level1name = N'ResolveTime';
