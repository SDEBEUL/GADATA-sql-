...
CREATE PROCEDURE [Volvo].[sp_GADATAFront_testGLUE4]
--timeparameters
...
AND 
--Robot name filter 
(GL_A.Robotname LIKE @RobotFilterWild)
AND
@GetTeamster = 1
...
AND 
--Robot name filter 
(GL_O.Robotname LIKE @RobotFilterWild)
AND 
@GetTeamster = 1
