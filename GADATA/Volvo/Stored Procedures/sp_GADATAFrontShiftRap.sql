...
, 'ShiftRap for:  ' + cast(t.Year as varchar(4)) + 'W' + cast(t.Week as varchar(2)) + ' | above here starts day ' + cast(t.day as varchar(1)) as 'Logtekst'
, null as 'downtime'
, null as 'count'
, null as 'Object'
, null as 'Subgroup'
...
,'Ruleinfo' as 'ErrorType'
, GETDATE()+'1900-01-02 00:00:00' as 'timestamp'
, 'Grouped by day |@minDowntime = ' + CAST(@minDowntime as varchar(5)) +
  '   |@minCountOfDowtime = ' + CAST(@minCountOfDowtime as varchar(5)) + 
  '   |@minCountofWarning = ' + CAST(@minCountofWarning as varchar(5)) 
    as 'Logtekst'
,  NULL as 'downtime'
...
, t.ErrorType
, min(t.timestamp) as 'timestamp'
, null as 'Logtekst' --'ShiftRap for:  ' + cast(min(t.Year) as varchar(4)) +  ' | above here starts week ' + cast(min(t.Week) as varchar(2)) as 'Logtekst'
, null as 'downtime'
, null as 'count'
, null as 'Object'
, null as 'Subgroup'
...
,'Ruleinfo' as 'ErrorType'
, GETDATE()+'1900-01-02 00:00:00' as 'timestamp'
, 'Grouped by week |@minDowntime = ' + CAST(@minDowntime as varchar(5)) +
  '   |@minCountOfDowtime = ' + CAST(@minCountOfDowtime as varchar(5)) + 
  '   |@minCountofWarning = ' + CAST(@minCountofWarning as varchar(5)) 
    as 'Logtekst'
,  NULL as 'downtime'
