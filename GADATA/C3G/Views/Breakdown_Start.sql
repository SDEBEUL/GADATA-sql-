...
*******************************************************************************************************--
*******************************************************************************************************--*/
CREATE VIEW [C3G].[Breakdown_Start]
AS
--*******************************************************************************************************--
--c3g breakdown
--*******************************************************************************************************--
...
, Isnull(L.error_text,'Fail: ' + GADATA.C3G.[fn_ShortSysstate](H.Trig_state))AS 'logtext'
, null		AS 'Response(s)' 
, null AS 'Downtime(s)'
, RTRIM(ISNULL(cc.Classification,'Undefined*'))  AS 'Classification'
, ISNULL(ISNULL(cs.Subgroup,GADATA.[C3G].[fn_GetSubgroupFromSysstate2](H.Trig_state)),'Undefined*')  AS 'Subgroup'
, H.id				 AS 'refId'
   ...
   Begin DiagramPane = 
      ...
      Begin Tables = 
         ...
         Begin Table = "c"
            ...
            DisplayFlags = 280
            TopColumn = 0
         ', @level0type = N'SCHEMA', @level0name = N'C3G', @level1type = N'VIEW', @level1name = N'Breakdown_Start';


GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'C3G', @level1type = N'VIEW', @level1name = N'Breakdown_Start';
