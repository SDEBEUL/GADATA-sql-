CREATE PROCEDURE [C3G].[sp_UPDATE_abb_APPL_Subgroup]
...
---------------------------------------------------------------------------------------
print '--*****************************************************************************--'
print '--[C3G].[sp_UPDATE_abb_APPL_Subgroup]--'
print '--*****************************************************************************--'
---------------------------------------------------------------------------------------
---------------------------------------------------------------------------------------
...
,Subgroup.Subgroup
FROM GADATA.C3G.L_error as L 
JOIN C3G.c_Appl as Appl on (Appl.id = L.Appl_id)
JOIN C3G.c_subgroup as Subgroup on (Subgroup.id = L.Subgroup_id)
