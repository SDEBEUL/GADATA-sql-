...
WHERE   (C.[Type] LIKE '%S4%') AND L.category_id not in (13)
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'ABB', @level1type = N'VIEW', @level1name = N'S4error';
...
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPane2', @value = N'   Table = 1170
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'ABB', @level1type = N'VIEW', @level1name = N'S4error';
