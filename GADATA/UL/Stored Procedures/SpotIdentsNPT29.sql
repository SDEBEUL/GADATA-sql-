...
-- =============================================
CREATE PROCEDURE [UL].[SpotIdentsNPT29]
...
--insert spotident
INSERT INTO [UL].[IdentsNPT29] (timestamp,spotid)
...
SELECT datetime, spotname
                  ...
                  [UL].[IdentsNPT29] ON tbl.datetime = [UL].[IdentsNPT29].timestamp
WHERE  ([UL].[IdentsNPT29].timestamp IS NULL)
 --insert spotBefore
 INSERT INTO [UL].[IdentsNPT29] (timestamp,spotid)
...
INSERT INTO [UL].[ErrorHandling]([procedure]
  ...
  SELECT 
    '[UL].[spotidentNPT29]_fault_catch'
