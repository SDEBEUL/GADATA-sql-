...
-- =============================================
CREATE PROCEDURE [UL].[SpotIdentsNPT73]
...
--insert spotident
INSERT INTO [UL].[IdentsNPT73] (timestamp,spotid)
...
SELECT datetime, spotname
                  ...
                  [UL].[IdentsNPT73] ON tbl.datetime = [UL].[IdentsNPT73].timestamp
WHERE  ([UL].[IdentsNPT73].timestamp IS NULL)
 --insert spotBefore
...
INSERT INTO [UL].[ErrorHandling]([procedure]
  ...
  SELECT 
    '[UL].[spotidentNPT73]_fault_catch'
