...
-- =============================================
CREATE PROCEDURE [UL].[SpotIdentsNPT70]
...
--insert spotident
INSERT INTO [UL].[IdentsNPT70] (timestamp,spotid)
...
SELECT datetime, spotname
                  ...
                  [UL].[IdentsNPT70] ON tbl.datetime = [UL].[IdentsNPT70].timestamp
WHERE  ([UL].[IdentsNPT70].timestamp IS NULL)
 --insert spotBefore
 INSERT INTO [UL].[IdentsNPT70] (timestamp,spotid)
...
INSERT INTO [UL].[ErrorHandling]([procedure]
  ...
  SELECT 
    '[UL].[spotidentNPT70]_fault_catch'
