...
-- =============================================
CREATE PROCEDURE [UL].[SpotIdentsNPT56]
...
--insert spotident
INSERT INTO [UL].[IdentsNPT56] (timestamp,spotid)
...
SELECT datetime, spotname
                  ...
                  [UL].[IdentsNPT56] ON tbl.datetime = [UL].[IdentsNPT56].timestamp
WHERE  ([UL].[IdentsNPT56].timestamp IS NULL)
 --insert spotBefore
 INSERT INTO [UL].[IdentsNPT56] (timestamp,spotid)
...
INSERT INTO [UL].[ErrorHandling]([procedure]
  ...
  SELECT 
    '[UL].[spotidentNPT56]_fault_catch'
