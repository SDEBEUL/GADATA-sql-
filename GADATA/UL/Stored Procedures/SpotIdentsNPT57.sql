...
SELECT datetime, spotname
                  ...
                  [UL].[IdentsNPT57] ON tbl.datetime = [UL].[IdentsNPT57].timestamp
WHERE  ([UL].[IdentsNPT57].timestamp IS NULL)
 --insert spotBefore
 INSERT INTO [UL].[IdentsNPT57] (timestamp,spotid)
...
INSERT INTO [UL].[ErrorHandling]([procedure]
  ...
  SELECT 
    '[UL].[spotidentNPT57]_fault_catch'
