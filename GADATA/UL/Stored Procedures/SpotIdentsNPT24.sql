...
-- =============================================
CREATE PROCEDURE [UL].[SpotIdentsNPT24]
...
INSERT INTO [UL].[IdentsNPT24] (timestamp,spotid)
...
SELECT datetime, spotname
                  ...
                  [UL].[IdentsNPT24] ON tbl.datetime = [UL].[IdentsNPT24].timestamp
WHERE  ([UL].[IdentsNPT24].timestamp IS NULL)
 --insert spotBefore
 INSERT INTO [UL].[IdentsNPT24] (timestamp,spotid)
...
INSERT INTO [UL].[ErrorHandling]([procedure]
  ...
  SELECT 
    '[UL].[spotidentNPT24]_fault_catch'
