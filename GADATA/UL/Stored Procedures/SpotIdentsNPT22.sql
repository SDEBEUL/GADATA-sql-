...
-- =============================================
CREATE PROCEDURE [UL].[SpotIdentsNPT22]
...
INSERT INTO [UL].[IdentsNPT22] (timestamp,spotid)
...
SELECT datetime, spotname
                  ...
                  UL.[IdentsNPT22] ON tbl.datetime = UL.[IdentsNPT22].timestamp
WHERE  (UL.[IdentsNPT22].timestamp IS NULL)
 --insert spotBefore
 INSERT INTO [UL].[IdentsNPT22] (timestamp,spotid)
...
INSERT INTO [UL].[ErrorHandling]([procedure]
  ...
  SELECT 
    '[UL].[spotidentNPT22]_fault_catch'
