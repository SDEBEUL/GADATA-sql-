...
-- =============================================
CREATE PROCEDURE [UL].[spotidentsNPT72]
...
--insert spotident
INSERT INTO [UL].[IdentsNPT72] (timestamp,spotid)
...
SELECT datetime, spotname
                  ...
                  [UL].[IdentsNPT72] ON tbl.datetime = [UL].[IdentsNPT72].timestamp
WHERE  ([UL].[IdentsNPT72].timestamp IS NULL)
 --insert spotBefore
 INSERT INTO [UL].[IdentsNPT72] (timestamp,spotid)
...
INSERT INTO [UL].[ErrorHandling]([procedure]
  ...
  SELECT 
    '[UL].[spotidentNPT72]_fault_catch'
