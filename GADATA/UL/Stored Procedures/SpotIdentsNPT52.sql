...
-- =============================================
CREATE PROCEDURE [UL].[SpotIdentsNPT52]
...
--insert spotident
INSERT INTO [UL].[IdentsNPT52] (timestamp,spotid)
...
SELECT datetime, spotname
                  ...
                  [UL].[IdentsNPT52] ON tbl.datetime = [UL].[IdentsNPT52].timestamp
WHERE  ([UL].[IdentsNPT52].timestamp IS NULL)
 --insert spotBefore
 INSERT INTO [UL].[IdentsNPT52] (timestamp,spotid)
...
INSERT INTO [UL].[ErrorHandling]([procedure]
  ...
  SELECT 
    '[UL].[spotidentNPT52]_fault_catch'
