...
-- =============================================
CREATE PROCEDURE [UL].[SpotIdentsNPT50]
...
--insert spotident
INSERT INTO [UL].[IdentsNPT50] (timestamp,spotid)
...
SELECT datetime, spotname
                  ...
                  [UL].[IdentsNPT50] ON tbl.datetime = [UL].[IdentsNPT50].timestamp
WHERE  ([UL].[IdentsNPT50].timestamp IS NULL)
 --insert spotBefore
 INSERT INTO [UL].[IdentsNPT50] (timestamp,spotid)
...
INSERT INTO [UL].[ErrorHandling]([procedure]
  ...
  SELECT 
    '[UL].[spotidentNPT50]_fault_catch'
