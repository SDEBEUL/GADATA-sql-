...
-- =============================================
CREATE PROCEDURE [UL].[SpotIdentsNPT41]
...
--insert spotident
INSERT INTO [UL].[IdentsNPT41] (timestamp,spotid)
...
SELECT datetime, spotname
                  ...
                  [UL].[IdentsNPT41] ON tbl.datetime = [UL].[IdentsNPT41].timestamp
WHERE  ([UL].[IdentsNPT41].timestamp IS NULL)
 --insert spotBefore
 INSERT INTO [UL].[IdentsNPT41] (timestamp,spotid)
...
INSERT INTO [UL].[ErrorHandling]([procedure]
  ...
  SELECT 
    '[UL].[spotidentNPT41]_fault_catch'
