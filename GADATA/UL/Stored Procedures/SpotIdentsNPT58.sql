...
-- =============================================
CREATE PROCEDURE [UL].[SpotIdentsNPT58]
...
--insert spotident
INSERT INTO [UL].[IdentsNPT58] (timestamp,spotid)
...
SELECT datetime, spotname
                  ...
                  [UL].[IdentsNPT58] ON tbl.datetime = [UL].[IdentsNPT58].timestamp
WHERE  ([UL].[IdentsNPT58].timestamp IS NULL)
 --insert spotBefore
 INSERT INTO [UL].[IdentsNPT58] (timestamp,spotid)
...
INSERT INTO [UL].[ErrorHandling]([procedure]
  ...
  SELECT 
    '[UL].[spotidentNPT58]_fault_catch'
