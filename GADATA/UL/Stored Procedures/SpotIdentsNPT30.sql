...
-- =============================================
CREATE PROCEDURE [UL].[SpotIdentsNPT30]
...
--insert spotident
INSERT INTO [UL].[IdentsNPT30] (timestamp,spotid)
...
SELECT datetime, spotname
                  ...
                  [UL].[IdentsNPT30] ON tbl.datetime = [UL].[IdentsNPT30].timestamp
WHERE  ([UL].[IdentsNPT30].timestamp IS NULL)
 --insert spotBefore
 INSERT INTO [UL].[IdentsNPT30] (timestamp,spotid)
...
INSERT INTO [UL].[ErrorHandling]([procedure]
  ...
  SELECT 
    '[UL].[spotidentNPT30]_fault_catch'
