...
-- =============================================
CREATE PROCEDURE [UL].[SpotIdentsNPT43]
...
--insert spotident
INSERT INTO [UL].[IdentsNPT43] (timestamp,spotid)
...
SELECT datetime, spotname
                  ...
                  [UL].[IdentsNPT43] ON tbl.datetime = [UL].[IdentsNPT43].timestamp
WHERE  ([UL].[IdentsNPT43].timestamp IS NULL)
 --insert spotBefore
 INSERT INTO [UL].[IdentsNPT43] (timestamp,spotid)
...
INSERT INTO [UL].[ErrorHandling]([procedure]
  ...
  SELECT 
    '[UL].[spotidentNPT43]_fault_catch'
