...
-- =============================================
CREATE PROCEDURE [UL].[SpotIdentsNPT40]
...
--insert spotident
INSERT INTO [UL].[IdentsNPT40] (timestamp,spotid)
...
SELECT datetime, spotname
                  ...
                  [UL].[IdentsNPT40] ON tbl.datetime = [UL].[IdentsNPT40].timestamp
WHERE  ([UL].[IdentsNPT40].timestamp IS NULL)
 --insert spotBefore
 INSERT INTO [UL].[IdentsNPT40] (timestamp,spotid)
...
INSERT INTO [UL].[ErrorHandling]([procedure]
  ...
  SELECT 
    '[UL].[spotidentNPT40]_fault_catch'
