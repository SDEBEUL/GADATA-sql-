...
-- =============================================
CREATE PROCEDURE [UL].[SpotIdentsNPT33]
...
--insert spotident
INSERT INTO [UL].[IdentsNPT33] (timestamp,spotid)
...
SELECT datetime, spotname
                  ...
                  [UL].[IdentsNPT33] ON tbl.datetime = [UL].[IdentsNPT33].timestamp
WHERE  ([UL].[IdentsNPT33].timestamp IS NULL)
 --insert spotBefore
 INSERT INTO [UL].[IdentsNPT33] (timestamp,spotid)
...
INSERT INTO [UL].[ErrorHandling]([procedure]
  ...
  SELECT 
    '[UL].[spotidentNPT33]_fault_catch'
