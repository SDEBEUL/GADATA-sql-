...
-- =============================================
CREATE PROCEDURE [UL].[SpotIdentsNPT26]
...
INSERT INTO [UL].[IdentsNPT26] (timestamp,spotid)
...
SELECT datetime, spotname
                  ...
                  [UL].[IdentsNPT26] ON tbl.datetime = [UL].[IdentsNPT26].timestamp
WHERE  ([UL].[IdentsNPT26].timestamp IS NULL)
 --insert spotBefore
 INSERT INTO [UL].[IdentsNPT26] (timestamp,spotid)
...
INSERT INTO [UL].[ErrorHandling]([procedure]
  ...
  SELECT 
    '[UL].[spotidentNPT26]_fault_catch'
