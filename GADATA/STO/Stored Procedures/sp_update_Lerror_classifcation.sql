...
CREATE PROCEDURE [STO].[sp_update_Lerror_classifcation]
...
--get classification
LEFT JOIN GADATA.STO.c_LogClassRules as Cr ON 
(
--for sto we do not handel logcodes 
	(L.ALARMCOMMENT LIKE RTRIM(Cr.Err_text))
)
WHERE 
