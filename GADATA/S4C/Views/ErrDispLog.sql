...
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'S4C', @level1type = N'VIEW', @level1name = N'ErrDispLog';
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'S4C', @level1type = N'VIEW', @level1name = N'ErrDispLog';
