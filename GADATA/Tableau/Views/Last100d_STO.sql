...
LEFT OUTER JOIN gadata.equi.GeoASSETS as A  on A.LocationTree = e.LocationTree
...
Begin DesignProperties = 
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'Tableau', @level1type = N'VIEW', @level1name = N'Last100d_STO';
