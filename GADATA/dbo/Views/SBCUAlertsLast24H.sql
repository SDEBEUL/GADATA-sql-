...
HAVING        (logtext LIKE 'SBCU warning: MinUpdate%')
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 1, @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'SBCUAlertsLast24H';
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[31] 4[27] 2[17] 3) )"
      End
   ...
   Begin DiagramPane = 
      ...
      End
      Begin Tables = 
         Begin Table = "SBCUoutOfLimit (C3G)"
            Begin Extent = 
               Top = 4
               Left = 36
               Bottom = 244
   ...
   End
End
', @level0type = N'SCHEMA', @level0name = N'dbo', @level1type = N'VIEW', @level1name = N'SBCUAlertsLast24H';
