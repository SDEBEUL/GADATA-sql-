...
AS
SELECT        dbo.WeldFaultLog.DateTime, dbo.Timer.Name, dbo.Spot.Program, dbo.Spot.Number, dbo.NPT.Name AS NPT, dbo.WeldFaultName.WeldFaultName, 
                         dbo.WeldFaultLog.Wear
