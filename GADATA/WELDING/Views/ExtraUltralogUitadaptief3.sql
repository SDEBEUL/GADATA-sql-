...
HAVING        (MAX(dbo.WeldMeasurements.Date) >= GETDATE() - 14) AND (WELDING.Qcontrol.[uit adaptief] = 1) AND (dbo.Spot.Number BETWEEN 30000 AND 49999) OR
                         (MAX(dbo.WeldMeasurements.Date) >= GETDATE() - 14) AND (WELDING.Qcontrol.[uit adaptief] = 1) AND (dbo.Spot.Number BETWEEN 4400000 AND 4419999)
GO
...
Begin DesignProperties = 
   Begin PaneConfigurations = 
      Begin PaneConfiguration = 0
         NumPanes = 4
         Configuration = "(H (1[35] 4[18] 2[15] 3) )"
      End
