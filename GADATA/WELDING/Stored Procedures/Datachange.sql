...
--create table #temp9876 ( SpotID int,DateTime datetime   ,ParameterId int ,OldValue nchar(50)  ,NewValue nchar(50)  ,UserID int)
...
FROM            dbo.Timer INNER JOIN
                         ...
                         OPENQUERY([19.148.189.9\bos_sqlserv_2005], 
...
FROM            OPENQUERY([19.148.189.9\bos_sqlserv_2005], 
                         ...
                         dbo.Timer ON Datachange.timerName = dbo.Timer.Name INNER JOIN
                         dbo.TimerParameterName ON Datachange.param_id = dbo.TimerParameterName.LocalDbID INNER JOIN
                         dbo.Users ON Datachange.userName = dbo.Users.CDSID LEFT OUTER JOIN
...
FROM            dbo.Timer INNER JOIN
                         dbo.Spot ON dbo.Timer.ID = dbo.Spot.TimerID INNER JOIN
                         OPENQUERY([19.148.170.244\bos_sqlserv_2005], 
                         '                  SELECT        CONVERT(Datetime, dateTime, 120) AS Timestamp, timerName, param_status_txt, subIndex, oldValue_txt, newValue_txt, userName,param_id                 FROM            dbo.ExtDataChangeProt_V WHERE param_id <> ''116'' 
						     ')
                          AS Datachange ON dbo.Spot.Program = Datachange.subIndex AND dbo.Timer.Name = Datachange.timerName collate database_default INNER JOIN
                         dbo.TimerParameterName ON Datachange.param_id = dbo.TimerParameterName.LocalDbID INNER JOIN
...
FROM            dbo.Timer INNER JOIN
                         dbo.Spot ON dbo.Timer.ID = dbo.Spot.TimerID INNER JOIN
                         OPENQUERY([19.148.170.103\bos_sqlserv_2005], 
...
FROM            dbo.Timer INNER JOIN
                         dbo.Spot ON dbo.Timer.ID = dbo.Spot.TimerID INNER JOIN
                         OPENQUERY([19.148.184.10\bos_sqlserv_2005], 
                         '                  SELECT        CONVERT(Datetime, dateTime, 120) AS Timestamp, timerName, param_status_txt, subIndex, oldValue_txt, newValue_txt, userName,param_id                 FROM            dbo.ExtDataChangeProt_V WHERE param_id <> ''116'' 
						     ')
                          AS Datachange ON dbo.Spot.Program = Datachange.subIndex AND dbo.Timer.Name = Datachange.timerName collate database_default INNER JOIN
                         dbo.TimerParameterName ON Datachange.param_id = dbo.TimerParameterName.LocalDbID INNER JOIN
...
FROM            dbo.Timer INNER JOIN
                         dbo.Spot ON dbo.Timer.ID = dbo.Spot.TimerID INNER JOIN
                         OPENQUERY([19.148.185.36\bos_sqlserv_2005], 
                         '                  SELECT        CONVERT(Datetime, dateTime, 120) AS Timestamp, timerName, param_status_txt, subIndex, oldValue_txt, newValue_txt, userName,param_id                 FROM            dbo.ExtDataChangeProt_V WHERE param_id <> ''116'' 
						     ')
                          AS Datachange ON dbo.Spot.Program = Datachange.subIndex AND dbo.Timer.Name = Datachange.timerName collate database_default INNER JOIN
                         dbo.TimerParameterName ON Datachange.param_id = dbo.TimerParameterName.LocalDbID INNER JOIN
...
FROM            dbo.Timer INNER JOIN
                         dbo.Spot ON dbo.Timer.ID = dbo.Spot.TimerID INNER JOIN
                         OPENQUERY([19.148.185.37\bos_sqlserv_2005], 
                         '                  SELECT        CONVERT(Datetime, dateTime, 120) AS Timestamp, timerName, param_status_txt, subIndex, oldValue_txt, newValue_txt, userName,param_id                 FROM            dbo.ExtDataChangeProt_V WHERE param_id <> ''116'' 
						     ')
                          AS Datachange ON dbo.Spot.Program = Datachange.subIndex AND dbo.Timer.Name = Datachange.timerName collate database_default INNER JOIN
                         dbo.TimerParameterName ON Datachange.param_id = dbo.TimerParameterName.LocalDbID INNER JOIN
...
FROM            dbo.Timer INNER JOIN
                         dbo.Spot ON dbo.Timer.ID = dbo.Spot.TimerID INNER JOIN
                         OPENQUERY([19.148.179.160\bos_sqlserv_2005], 
                         '                  SELECT        CONVERT(Datetime, dateTime, 120) AS Timestamp, timerName, param_status_txt, subIndex, oldValue_txt, newValue_txt, userName,param_id                 FROM            dbo.ExtDataChangeProt_V WHERE param_id <> ''116'' 
						     ')
                          AS Datachange ON dbo.Spot.Program = Datachange.subIndex AND dbo.Timer.Name = Datachange.timerName collate database_default INNER JOIN
                         dbo.TimerParameterName ON Datachange.param_id = dbo.TimerParameterName.LocalDbID INNER JOIN
...
FROM            dbo.Timer INNER JOIN
                         dbo.Spot ON dbo.Timer.ID = dbo.Spot.TimerID INNER JOIN
                         OPENQUERY([19.148.179.161\bos_sqlserv_2005], 
                         '                  SELECT        CONVERT(Datetime, dateTime, 120) AS Timestamp, timerName, param_status_txt, subIndex, oldValue_txt, newValue_txt, userName,param_id                 FROM            dbo.ExtDataChangeProt_V WHERE param_id <> ''116'' 
						     ')
                          AS Datachange ON dbo.Spot.Program = Datachange.subIndex AND dbo.Timer.Name = Datachange.timerName collate database_default INNER JOIN
                         dbo.TimerParameterName ON Datachange.param_id = dbo.TimerParameterName.LocalDbID INNER JOIN
...
FROM            dbo.Timer INNER JOIN
                         dbo.Spot ON dbo.Timer.ID = dbo.Spot.TimerID INNER JOIN
                         OPENQUERY([19.148.182.11\bos_sqlserv_2005], 
                         '                  SELECT        CONVERT(Datetime, dateTime, 120) AS Timestamp, timerName, param_status_txt, subIndex, oldValue_txt, newValue_txt, userName,param_id                 FROM            dbo.ExtDataChangeProt_V WHERE param_id <> ''116'' 
						     ')
                          AS Datachange ON dbo.Spot.Program = Datachange.subIndex AND dbo.Timer.Name = Datachange.timerName collate database_default INNER JOIN
                         dbo.TimerParameterName ON Datachange.param_id = dbo.TimerParameterName.LocalDbID INNER JOIN
...
FROM            dbo.Timer INNER JOIN
                         dbo.Spot ON dbo.Timer.ID = dbo.Spot.TimerID INNER JOIN
                         OPENQUERY([136.20.175.212\bos_sqlserv_2005], 
                         '                  SELECT        CONVERT(Datetime, dateTime, 120) AS Timestamp, timerName, param_status_txt, subIndex, oldValue_txt, newValue_txt, userName,param_id                 FROM            dbo.ExtDataChangeProt_V WHERE param_id <> ''116'' 
						     ')
                          AS Datachange ON dbo.Spot.Program = Datachange.subIndex AND dbo.Timer.Name = Datachange.timerName collate database_default INNER JOIN
                         dbo.TimerParameterName ON Datachange.param_id = dbo.TimerParameterName.LocalDbID INNER JOIN
...
FROM            dbo.Timer INNER JOIN
                         dbo.Spot ON dbo.Timer.ID = dbo.Spot.TimerID INNER JOIN
                         OPENQUERY([136.20.175.213\bos_sqlserv_2005], 
                         '                  SELECT        CONVERT(Datetime, dateTime, 120) AS Timestamp, timerName, param_status_txt, subIndex, oldValue_txt, newValue_txt, userName,param_id                 FROM            dbo.ExtDataChangeProt_V WHERE param_id <> ''116'' 
						     ')
                          AS Datachange ON dbo.Spot.Program = Datachange.subIndex AND dbo.Timer.Name = Datachange.timerName collate database_default INNER JOIN
                         dbo.TimerParameterName ON Datachange.param_id = dbo.TimerParameterName.LocalDbID INNER JOIN
...
FROM            dbo.Timer INNER JOIN
                         dbo.Spot ON dbo.Timer.ID = dbo.Spot.TimerID INNER JOIN
                         OPENQUERY([136.20.175.254\bos_sqlserv_2005], 
                         '                  SELECT        CONVERT(Datetime, dateTime, 120) AS Timestamp, timerName, param_status_txt, subIndex, oldValue_txt, newValue_txt, userName,param_id                 FROM            dbo.ExtDataChangeProt_V WHERE param_id <> ''116'' 
						     ')
                          AS Datachange ON dbo.Spot.Program = Datachange.subIndex AND dbo.Timer.Name = Datachange.timerName collate database_default INNER JOIN
                         dbo.TimerParameterName ON Datachange.param_id = dbo.TimerParameterName.LocalDbID INNER JOIN
...
FROM            dbo.Timer INNER JOIN
                         dbo.Spot ON dbo.Timer.ID = dbo.Spot.TimerID INNER JOIN
                         OPENQUERY([19.148.176.27\bos_sqlserv_2005], 
                         '                  SELECT        CONVERT(Datetime, dateTime, 120) AS Timestamp, timerName, param_status_txt, subIndex, oldValue_txt, newValue_txt, userName,param_id                 FROM            dbo.ExtDataChangeProt_V WHERE param_id <> ''116'' 
						     ')
                          AS Datachange ON dbo.Spot.Program = Datachange.subIndex AND dbo.Timer.Name = Datachange.timerName collate database_default INNER JOIN
                         dbo.TimerParameterName ON Datachange.param_id = dbo.TimerParameterName.LocalDbID INNER JOIN
