...
CREATE PROCEDURE [EqUi].[AAOSR_RobotFront]
...
AND
--robot name filter 
(RespT.Robotname LIKE @locations)
--enable bit
And 
@RespT = 1
---------------------------------------------------------------------------------------
...
AND
--robot name filter 
(RelvT.Robotname LIKE @locations)
--enable bit
And 
@RelvT = 1
---------------------------------------------------------------------------------------
...
AND 
--Robot name filter 
(C4GSPEED.Robotname LIKE @locations)
AND 
@GetC4GSpeedCheck = 1
---------------------------------------------------------------------------------------
...
WHERE
--Robot name filter 
(C4GSlowSPEED.Robotname LIKE @locations)
AND 
@GetC4GLive = 1
---------------------------------------------------------------------------------------
...
AND 
--Robot name filter 
(C4Gsbcu.Robotname LIKE @locations)
AND 
@GetC4GSBCU = 1
---------------------------------------------------------------------------------------
...
AND 
--Robot name filter 
(C3GSBCU.Robotname LIKE @locations)
AND 
@GetC3GSBCU = 1
---------------------------------------------------------------------------------------
...
AND 
--Robot name filter 
(IRC5E.Robotname LIKE @locations)
--Application / subgroup filter
AND
...
AND 
--Robot name filter 
(IRC5S.Robotname LIKE @locations)
AND 
@GetIRC5State = 1
