CREATE VIEW LAUNCH.Greenfield_Weldmeasurements
AS
...
WHERE        (dbo.Spot.Number > 4400000) AND (dbo.Spot.Number < 4419999)
ORDER BY dbo.WeldMeasurements.Date, dbo.WeldMeasurements.Shift
GO
EXECUTE sp_addextendedproperty @name = N'MS_DiagramPaneCount', @value = 2, @level0type = N'SCHEMA', @level0name = N'LAUNCH', @level1type = N'VIEW', @level1name = N'Greenfield_Weldmeasurements';
...
Begin DesignProperties = 
   ...
   Begin CriteriaPane = 
      Begin ColumnWidths = 11
         ...
         SortOrder = 1410
         GroupBy = 1350
    ', @level0type = N'SCHEMA', @level0name = N'LAUNCH', @level1type = N'VIEW', @level1name = N'Greenfield_Weldmeasurements';
